...
"""
Main program for Murphy's Revenge. 

This file is essentially a cut/past of the Rietvield 2.0 main.py file, which 
is (c) 2008 Google Inc and licensed under the Apache 2.0 License.

This effectively bootstraps our django app.
"""
...
def real_main():
  """Main program."""
  # Don't ask. :-(
  if os.getenv('HTTP_HOST') == 'murphys-revenge.appspot.com':
