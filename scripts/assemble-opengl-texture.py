...
FILE_INFO = [
    ...
    (
        ...
        1,
        22,
    ),  # really 16, but extend to include oliver.bmp in nice location
    ("oliver.bmp", 1, 90),
]
...
def copy_tile(
    ...
    source_rect = (
        ...
        source_tile_y * (TILE_SIZE + source_y_separation),
        TILE_SIZE,
        TILE_SIZE,
    )
    target_rect = (
        target_tile_x * TILE_SIZE,
        target_tile_y * TILE_SIZE,
        TILE_SIZE,
        TILE_SIZE,
    )
...
if __name__ == "__main__":
    ...
    for file_name, y_separation, tile_count in FILE_INFO:
        ...
        if tiles is None:
            ...
            file_tiles_down = (file_pixel_height + y_separation) / (
                TILE_SIZE + y_separation
            )
